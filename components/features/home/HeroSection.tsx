...
export default function HeroSection({ children }: { children: ReactNode }) {
  ...
  // with a translucent background further down the page. The intro text now
  // lives inside this same viewport (an overlay, not its own scroll section),
  // so one screen height is the whole hero — the next scroll goes straight
  // to About.
